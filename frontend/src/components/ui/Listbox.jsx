  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={cn(
          "group flex  w-full items-center justify-between gap-2 rounded-full border border-[var(--border)] bg-[var(--surface)] px-4 py-2.5  text-sm text-[var(--ink)] outline-none transition-colors",
